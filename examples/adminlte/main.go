...
func handleHome(w http.ResponseWriter, r *http.Request) {
	...
	if theme == "" {
		...
		theme = lo.Ternary(err == nil && cookie != nil && cookie.Value != "", cookie.Value, "adminlte")
	}
	...
	// Set dashboard title
	d.SetTitle("AdminLTE Dashboard")

	// Set logo and navbar settings
	d.SetLogoImageURL("https://adminlte.io/themes/v3/dist/img/AdminLTELogo.png")
